#pragma once
#include "../unitree_legs/unitreeMotor/unitreeMotor.h"
#include "../unitree_legs/serialPort/SerialPort.h"
#include <vector>
#include <map>
...
private:
    MotorCmd    cmd;    
    MotorData   data;
    inline static SerialPort serial{"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FT88PGWF-if00-port0"};
